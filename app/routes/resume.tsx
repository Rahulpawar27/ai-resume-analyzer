...
import { usePuterStore } from "/Users/rahul/WebstormProjects/ai-resume-analyzer/app/lib/puter";
...
const Resume = () => {
  ...
  useEffect(() => {
    const LoadResume = async (): Promise<void> => {
      const resume: string | null | undefined = await kv.get(`resume:${id}`);
      if (!resume) return;
  ...
  return (
    <main className="pt-0">
      ...
      <div className="flex flex-row w-full max-lg:flex-col-reverse">
        <section className="feedback-section className=bg-[url('/images/bg-small.svg')] bg-cover h-[100vh] sticky top-0 items-center justify-centre">
          {imageUrl && resumeUrl && (
